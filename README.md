## geometric_shapes (kilted) - 2.3.4-1

The packages in the `geometric_shapes` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted geometric_shapes` on `Wed, 12 Aug 2026 05:47:10 -0000`
...
## geometric_shapes (humble) - 2.3.4-1

The packages in the `geometric_shapes` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble geometric_shapes` on `Tue, 09 Jun 2026 12:44:16 -0000`
...
## geometric_shapes (jazzy) - 2.3.4-1

The packages in the `geometric_shapes` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy geometric_shapes` on `Tue, 09 Jun 2026 12:43:05 -0000`
...
## geometric_shapes (lyrical) - 2.3.4-1

The packages in the `geometric_shapes` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical geometric_shapes` on `Tue, 09 Jun 2026 12:42:00 -0000`
...
## geometric_shapes (rolling) - 2.3.4-1

The packages in the `geometric_shapes` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling geometric_shapes` on `Mon, 08 Jun 2026 15:13:08 -0000`
...
## geometric_shapes (kilted) - 2.3.3-1

The packages in the `geometric_shapes` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted geometric_shapes` on `Fri, 06 Jun 2025 11:45:25 -0000`
...
## geometric_shapes (rolling) - 2.3.3-1

The packages in the `geometric_shapes` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling geometric_shapes` on `Fri, 06 Jun 2025 11:43:42 -0000`
...
## geometric_shapes (rolling) - 2.3.2-1

The packages in the `geometric_shapes` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling geometric_shapes` on `Fri, 24 Jan 2025 03:24:08 -0000`
...
The packages in the `geometric_shapes` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy geometric_shapes` on `Fri, 24 Jan 2025 03:21:49 -0000`
...
The packages in the `geometric_shapes` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble geometric_shapes` on `Fri, 24 Jan 2025 03:20:22 -0000`
...
The packages in the `geometric_shapes` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy geometric_shapes -e` on `Fri, 06 Dec 2024 09:51:50 -0000`
...
The packages in the `geometric_shapes` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble geometric_shapes -e` on `Fri, 06 Dec 2024 09:49:55 -0000`
...
## geometric_shapes (rolling) - 2.3.1-1

The packages in the `geometric_shapes` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling geometric_shapes -e` on `Fri, 06 Dec 2024 09:47:59 -0000`
...
## geometric_shapes (rolling) - 2.3.0-1

The packages in the `geometric_shapes` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling geometric_shapes` on `Fri, 29 Nov 2024 14:47:15 -0000`
...
## geometric_shapes (jazzy) - 2.3.0-1

The packages in the `geometric_shapes` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy geometric_shapes` on `Fri, 29 Nov 2024 14:45:17 -0000`
...
## geometric_shapes (humble) - 2.3.0-1

The packages in the `geometric_shapes` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble geometric_shapes` on `Fri, 29 Nov 2024 14:41:47 -0000`
...
The packages in the `geometric_shapes` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy geometric_shapes` on `Wed, 26 Jun 2024 09:45:16 -0000`
...
## geometric_shapes (rolling) - 2.2.1-1

The packages in the `geometric_shapes` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling geometric_shapes` on `Wed, 26 Jun 2024 08:34:43 -0000`
